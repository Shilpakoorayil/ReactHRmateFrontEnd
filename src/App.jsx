...
import EmployeeAttendance from './pages/employee/EmpAttendance'
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
           ...
           <Route path="/settings" element={<PrivateRoute  roles={['admin','hr','employee']}><Settings /></PrivateRoute>} />
           <Route path="/teams" element={<PrivateRoute  roles={['admin','hr']}><Teams /></PrivateRoute>} />
            ...
            <Route path="/leaveapproval" element={<PrivateRoute roles={['admin','hr']}><AdminLeaveApproval /></PrivateRoute>} />
            <Route path="/my-attendance" element={<PrivateRoute roles={['employee']}><EmployeeAttendance /></PrivateRoute>} />
